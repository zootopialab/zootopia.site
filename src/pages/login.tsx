                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-2">
                    <div>
                      <a
                        href="#"
                        className="inline-flex justify-center w-full px-3 py-2 text-gray-500 bg-white rounded-md shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0"
                      >
